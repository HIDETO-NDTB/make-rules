...
class FrontEndController extends Controller
{
    ...
    public function result_total(){
        ...
        $total_vote = Vote::where('rule_id',$rules->id)->where('opinion',"")->count();
        $total_agree = Vote::where('rule_id',$rules->id)->where('vote','agree')->count();
        $total_disagree = Vote::where('rule_id',$rules->id)->where('vote','disagree')->count();
        $comments = Comment::orderBy('created_at','desc')->get();
        $users = User::all();
