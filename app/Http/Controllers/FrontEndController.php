...
class FrontEndController extends Controller
{
    public function index(){
        ...
        $total_vote = Vote::where('rule_id',$first_result->id)->where('opinion',"")->count();
        $total_agree = Vote::where('rule_id',$first_result->id)->where('vote','agree')->count();
        $total_disagree = Vote::where('rule_id',$first_result->id)->where('vote','disagree')->count();
        $rules = Rule::all();
