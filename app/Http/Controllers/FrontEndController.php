...
class FrontEndController extends Controller
{
    public function index(){
        ...
        $first_agree = Vote::isset($first_result)->where('rule_id',$first_result->id)->where('vote','agree')->count();
        $first_disagree = Vote::isset($first_result)->where('rule_id',$first_result->id)->where('vote','disagree')->count();
        $second_agree = Vote::isset($second_result)->where('rule_id',$second_result->id)->where('vote','agree')->count();
        $second_disagree = Vote::isset($second_result)->where('rule_id',$second_result->id)->where('vote','disagree')->count();
        $third_agree = Vote::isset($third_result)->where('rule_id',$third_result->id)->where('vote','agree')->count();
        $third_disagree = Vote::isset($third_result)->where('rule_id',$third_result->id)->where('vote','disagree')->count();
        $rules = Rule::all();
