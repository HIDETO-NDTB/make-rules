        ...
        <div class="row centered">
            <div class="col-lg-6">
                <div class="initiative-option">
                    <div class="use-top">
                        <a class="btn btn-success" style="width: 300px;" href="{{ route('how_to_use') }}">初めにお読み下さい</a>
                    </div>
    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-lg-6 col-lg-offset-2">
                <a href="">2020.1.23 Make Rulesリリースのお知らせ</a><br><br>
                <a href="">2020.1.25 開票済み一覧を追加</a><br><br>
            </div>
            <div class="col-lg-4">
                <div class="contact">
