...
<div class="container w">
    <div class="row centered">
        ...
        <div class="col-lg-4">
            ...
            <br>
            <li><a href="#">ベーシックインカム。全国民に月５万円支給<br>（あと３日で投票日）</a></li><br>
        ...
        <div class="col-lg-4">
            ...
            <br>
            <li><a href="{{ route('rule.single',['id' =>$rule->id]) }}">{{ $first_initiative->title }}<br>( {{ $first_initiative->initiative_date }} 発議 )</a></li><br>
            <li><a href="{{ route('rule.single',['id' =>$rule->id]) }}">{{ $second_initiative->title }}<br>( {{ $second_initiative->initiative_date }} 発議 )</a></li><br>
            <li><a href="{{ route('rule.single',['id' =>$rule->id]) }}">{{ $third_initiative->title }}<br>( {{ $third_initiative->initiative_date }} 発議 )</a></li><br>
        </div>
      <!-- col-lg-4 -->
