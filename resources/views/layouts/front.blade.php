  ...
  <div class="container w">
    <div class="row centered">
      ...
      <div class="col-lg-4">
        ...
        <li><a href="#">ベーシックインカム。全国民に毎月５万円を支給（あと３日で投票日）</a></li><br>
      ...
      <div class="col-lg-4">
        ...
        <li><a href="#">学校制服廃止法案（２月３日発議）</a></li><br>
      </div>
      <!-- col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <li><a href="#">出産を免許制にしませんか？（コメント数９７件）</a></li><br>
        <li><a href="#">ベーシックインカム。全国民に毎月５万円を支給（コメント数７３件）</a></li>
      </div>
      <!-- col-lg-4 -->
    </div>
    <!-- row -->
