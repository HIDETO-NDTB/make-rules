        ...
        <div class="row centered">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div id="resultform">
                    <div class="container">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            @if($total_agree->rule_id == $rule->id && $total_disagree->rule_id == $rule->id && $total_vote->rule_id == $rule->id)
                                <div class="result-option">
                                    @if(count($total_agree) > count($total_disagree))
                                    ...
                                    <div class="result-content">
                                        <li>総投票数　<strong>{{ count($total_vote) }}票</strong></li>
                                        <li>賛成　<strong>{{ count($total_agree) }}票</strong></li>
                                        <li>反対　<strong>{{ count($total_disagree) }}票</strong></li>
                                    </div>
                                </div>
                            @endif
                            </div>
